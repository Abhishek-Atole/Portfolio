  ...
  return (
    <section id="skills" className="py-20 bg-dark">
      <div className="container mx-auto max-w-6xl px-4">
        <h2 className="text-3xl font-bold text-center mb-16 text-gradient">MY SKILLS</h2>
        ...
        <h2 className="text-3xl font-bold text-center mb-16 text-gradient">MY STATS</h2>
